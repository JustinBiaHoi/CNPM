...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="POST">
         ...
         <input type="password" name="old_pass" maxlength="20" placeholder="Nhập mật khẩu cũ của bạn" class="box"
            oninput="this.value = this.value.replace(/\s/g, '')">
         <input type="password" name="new_pass" maxlength="20" placeholder="Nhập mật khẩu mới của bạn" class="box"
            oninput="this.value = this.value.replace(/\s/g, '')">
         <input type="password" name="confirm_pass" maxlength="20" placeholder="Xác nhận lại mật khẩu" class="box"
            oninput="this.value = this.value.replace(/\s/g, '')">
